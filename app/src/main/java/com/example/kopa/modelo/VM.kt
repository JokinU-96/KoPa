...
class VM: ViewModel() {
    ...
    fun insertarBebidas(){
        bebidas.add(Bebida("Cerveza", 0.33, 4, 6, 8, 12, 18, "#FFDA63"))
        bebidas.add(Bebida("Vino", 0.15, 4, 6, 8, 12, 18, "#8B0000"))
        bebidas.add(Bebida("Cerveza", 0.50, 3, 5, 7, 10, 15, "#F0E68C"))
        bebidas.add(Bebida("Pacharán", 0.10, 5, 7, 9, 14, 20, "#DC143C"))
        bebidas.add(Bebida("GinTonic", 0.50, 2, 3, 4, 6, 9, "#E0FFFF"))
        bebidas.add(Bebida("RonCola", 0.50, 2, 3, 4, 6, 9, "#8B4513"))
        bebidas.add(Bebida("Tequila", 0.05, 6, 8, 10, 15, 22, "#F4A460"))
        bebidas.add(Bebida("Vermouth", 0.10, 4, 6, 8, 12, 18, "#A0522D"))
    }
