        ...
        private val roomCallback = object : RoomDatabase.Callback() {
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                val bebidasIniciales = listOf(
                    Bebida(nombre = "Cerveza", cantidad = 0.33, vaso = 4, comida = 6, casa = 8, aviso = 12, muerte = 18, color = "#FFDA63", consumido = 2),
                    Bebida(nombre = "Vino", cantidad = 0.15, vaso = 4, comida = 6, casa = 8, aviso = 12, muerte = 18, color = "#8B0000", consumido = 2),
                    Bebida(nombre = "Cerveza", cantidad = 0.50, vaso = 3, comida = 5, casa = 7, aviso = 10, muerte = 15, color = "#F0E68C", consumido = 1),
                    Bebida(nombre = "Pacharán", cantidad = 0.10, vaso = 5, comida = 7, casa = 9, aviso = 14, muerte = 20, color = "#DC143C", consumido = 4),
